...
variable "docker_image_url_client" {
  ...
  default     = "868156198587.dkr.ecr.us-east-1.amazonaws.com/test-driven-client-fargate:prod"
}
variable "docker_image_url_users" {
  description = "Docker users image to run in the ECS cluster"
  default     = "868156198587.dkr.ecr.us-east-1.amazonaws.com/test-driven-users-fargate:prod"
}
variable "app_count" {
